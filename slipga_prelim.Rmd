...
params:
  ...
  clean_centiles_path: "/mnt/isilon/bgdlab_processing/Eren/slip_premie_wip/output/median-distinct-allgrades-25.11/data_clean/centiles_distinct_2026-01-29.csv"
...
if (!exists("params")) {
  params <- list(
  output_folder = "/mnt/isilon/bgdlab_processing/Eren/slip_premie_wip/output/median-ThMPR-distinct-allgrades-25.11/",
  clean_centiles_path = "/mnt/isilon/bgdlab_processing/Eren/slip_premie_wip/output/median-distinct-allgrades-25.11/data_clean/centiles_distinct_2026-01-27.csv", 
  slip_release_folder = "/mnt/isilon/bgdlab_processing/releases_clinical/2025_11_release/"
  )
}
print(params)
