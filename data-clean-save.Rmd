...
```
#DATA PREP - all four tables (mpr, mpr2, median, median2)
...
##GA and BW quality control -- for all
```{r}
##set bw > 1000kg to NA
...
sum(median_cent_distinct$gestational_age < 21, na.rm = TRUE)
...
sum(median2_cent_distinct$gestational_age < 21, na.rm = TRUE)
...
sum(mpr_cent_distinct$gestational_age < 21, na.rm = TRUE)
...
sum(mpr2_cent_distinct$gestational_age < 21, na.rm = TRUE)
