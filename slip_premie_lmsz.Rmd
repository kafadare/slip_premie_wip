...
# processed data path
centiles_data_path <- paste0(vars_path,"median_distinct_clean_2026-01-08.csv")
...
```{r}
full_vars <- read.csv(paste0(vars_path,"all_vars2025-12-05.csv")) %>% pull(x)
...
```{r}
write_csv(models_lpm, glue("{csv_save_path}lmsz_models_vpm.csv"))
write_csv(df_lpm, glue("{csv_save_path}lmsz_adjusted_centiles_vpm.csv"))
```
