...
vars_path <-  "/mnt/isilon/bgdlab_processing/Eren/slip_premie_wip/output/data_processed_csv/"
...
#processed data path
centiles_data_path <- paste0(vars_path,"liza_median_distinct_clean_2026-01-08.csv")

#output folder
save_path <- "/mnt/isilon/bgdlab_processing/Eren/slip_premie_wip/output/median-distinct-allgrades-liza/"
...
all_vars <- read.csv(paste0(vars_path,"all_vars2025-12-05.csv")) %>% pull(x)
global_vars <- read.csv(paste0(vars_path,"global_vars2025-12-05.csv")) %>% pull(x)
vol_vars <- read.csv(paste0(vars_path,"vol_vars2025-12-05.csv")) %>% pull(x)
sa_vars <- read.csv(paste0(vars_path,"sa_vars2025-12-05.csv")) %>% pull(x)
th_vars <- read.csv(paste0(vars_path,"th_vars2025-12-05.csv")) %>% pull(x)

full_df <- read.csv(centiles_data_path) %>% select(-("X"))
...
```{r, echo = FALSE}
vars_missing <- all_vars[!(all_vars %in% names(full_df))]
...
```{r, echo = FALSE}
missing_data_sessions <- full_df[rowSums(is.na(full_df[, all_vars, drop = FALSE])) > 0, ]$session_id
print(paste0("Number of sessions with any missing centile data: ", dim(missing_data_sessions)[1]))
missing_data_sessions_df <- full_df %>% filter(session_id %in% missing_data_sessions) %>% select(any_of(c("session_id", "participant_id", "age_years", all_vars)))
...
if(save_figs == TRUE){
panel_save(gabyage_dkt_sa_plot, "gabyage-dkt-sa", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(bwbyage_dkt_sa_plot, "bwbyage-dkt-sa", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(gabyage.qc_dkt_vol_plot, "gabyage-qc-dkt-vol", "pdf", plot_save_path)
panel_save(gabyage.qc_aseg_vol_plot , "gabyage-qc-aseg-vol", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(gabyage.qc_dkt_sa_plot, "gabyage-qc-dkt-sa", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(gabyage.qc_dkt_th_plot, "gabyage-qc-dkt-th", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(ga.qcyoung_dkt_th_plot, "ga-young-qc-dkt-th", "pdf", plot_save_path)
}
```
...
if(save_figs == TRUE){
panel_save(ga.qcold_dkt_th_plot, "ga-old-qc-dkt-th", "pdf", plot_save_path)
}
```
...
if(save_figs == TRUE){
panel_save(bwbyage.qc_dkt_vol_plot, "ga-qcbyage-dkt-vol", "pdf", plot_save_path)
panel_save(bwbyage.qc_aseg_vol_plot , "ga-qcbyage-aseg-vol", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(bwbyage.qc_dkt_sa_plot, "bwbyage-qc-dkt-sa", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(bwbyage.qc_dkt_th_plot, "bwbyage-qc-dkt-th", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(bw.qcyoung_dkt_th_plot, "bw-young-qc-dkt-th", "pdf", plot_save_path)
}
```
...
if(save_figs == TRUE){
panel_save(bw.qcold_dkt_th_plot, "bw-old-qc-dkt-th", "pdf", plot_save_path)
}
```
...
#####compute regressions
```{r, echo = FALSE}
print("Global measure for volume is eTIV")
sum(!is.na(df.zscore$gestational_age))
#Regional -- including cortical and subcortical
ga.qc.global_vol <- as.data.frame(t(sapply(df.zscore[, which(names(df.zscore) %in% vol_vars)], function(x) {
  lm <- lm(x ~ gestational_age + qc_var + global_eTIV, data = df.zscore)
  summary <- summary(lm)
  c(ga_beta = summary$coefficients[2,1], ga_p = summary$coefficients[2,4], ga_se = summary$coefficients[2,2])
})))
...
if(save_figs == TRUE){
panel_save(ga.qc.global_dkt_vol_plot, "ga-qc-global-dkt-vol", "pdf", plot_save_path)
panel_save(ga.qc.global_aseg_vol_plot , "ga-qc-global-aseg-vol", "pdf", plot_save_path)
}
```
#####Scatterplot for top betas
```{r, echo = FALSE}
...
gabyage.qc.global_vol <- as.data.frame(t(sapply(df.zscore[, which(names(df.zscore) %in% vol_vars)], function(x) {
  lm <- lm(x ~ gestational_age*age_years + qc_var + global_eTIV, data = df.zscore)
  summary <- summary(lm)
  c(ga_beta = summary$coefficients[2,1], ga_p = summary$coefficients[2,4], ga_se = summary$coefficients[2,2],
   age_beta = summary$coefficients[3,1], age_p = summary$coefficients[3,4], age_se = summary$coefficients[3,2],
...
if(save_figs == TRUE){
panel_save(gabyage.qc.global_dkt_vol_plot, "gabyage-qc-global-dkt-vol", "pdf", plot_save_path)
panel_save(gabyage.qc.global_aseg_vol_plot , "gabyage-qc-global-aseg-vol", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
#####compute regressions
```{r, echo = FALSE}
print("Global measure for surface area is eTIV")
sum(!is.na(df.zscore$gestational_age))
#Regional -- including cortical and subcortical
...
if(save_figs == TRUE){
panel_save(ga.qc.global_dkt_sa_plot, "ga-qc-global-dkt-sa", "pdf", plot_save_path)
}
```
#####Scatterplot for top betas
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(gabyage.qc_dkt_sa_plot, "gabyage-qc-global-dkt-sa", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
#####compute regressions
```{r, echo = FALSE}
print("Global measure for cortical thickness is mean thickness")
sum(!is.na(df.zscore$gestational_age))
#Regional -- including cortical and subcortical
ga.qc.global_th <- as.data.frame(t(sapply(df.zscore[, which(names(df.zscore) %in% th_vars)], function(x) {
  lm <- lm(x ~ gestational_age + qc_var + global_MeanThickness, data = df.zscore)
  summary <- summary(lm)
  c(ga_beta = summary$coefficients[2,1], ga_p = summary$coefficients[2,4], ga_se = summary$coefficients[2,2])
})))
...
if(save_figs == TRUE){
panel_save(ga.qc.global_dkt_th_plot, "ga-qc-global-dkt-th", "pdf", plot_save_path)
}
```
#####Scatterplot for top betas
```{r, echo = FALSE}
...
gabyage.qc.global_th <- as.data.frame(t(sapply(df.zscore[, which(names(df.zscore) %in% th_vars)], function(x) {
  lm <- lm(x ~ gestational_age*age_years + qc_var + global_MeanThickness, data = df.zscore)
  summary <- summary(lm)
  c(ga_beta = summary$coefficients[2,1], ga_p = summary$coefficients[2,4], ga_se = summary$coefficients[2,2],
   age_beta = summary$coefficients[3,1], age_p = summary$coefficients[3,4], age_se = summary$coefficients[3,2],
   gabyage_beta = summary$coefficients[5,1], gabyage_p = summary$coefficients[5,4], gabyage_se = summary$coefficients[5,2])
...
if(save_figs == TRUE){
panel_save(gabyage.qc.global_dkt_th_plot, "gabyage-qc-global-dkt-th", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
ga.qc.global_th_young <- as.data.frame(t(sapply(df.zscore_young[, which(names(df.zscore_young) %in% th_vars)], function(x) {
  lm <- lm(x ~ gestational_age + qc_var + global_MeanThickness, data = df.zscore_young)
  summary <- summary(lm)
  c(ga_beta = summary$coefficients[2,1], ga_p = summary$coefficients[2,4], ga_se = summary$coefficients[2,2])
})))
...
if(save_figs == TRUE){
panel_save(ga.qc.globalyoung_dkt_th_plot, "ga-qc-meanth-young-dkt-th", "pdf", plot_save_path)
}
```
...
ga.qc.global_th_old <- as.data.frame(t(sapply(df.zscore_old[, which(names(df.zscore_old) %in% th_vars)], function(x) {
  lm <- lm(x ~ gestational_age + qc_var + global_MeanThickness, data = df.zscore_old)
  summary <- summary(lm)
  c(ga_beta = summary$coefficients[2,1], ga_p = summary$coefficients[2,4], ga_se = summary$coefficients[2,2])
})))
...
if(save_figs == TRUE){
panel_save(ga.qc.globalold_dkt_th_plot, "ga-qc-meanth-old-dkt-th", "pdf", plot_save_path)
}
```
...
bw.qc.global_vol <- as.data.frame(t(sapply(df.zscore[, which(names(df.zscore) %in% vol_vars)], function(x) {
  lm <- lm(x ~ birth_weight_kg + qc_var + global_eTIV, data = df.zscore)
  summary <- summary(lm)
  c(bw_beta = summary$coefficients[2,1], bw_p = summary$coefficients[2,4], bw_se = summary$coefficients[2,2])
})))
...
if(save_figs == TRUE){
panel_save(bw.qc.global_dkt_vol_plot, "bw-qc-global-dkt-vol", "pdf", plot_save_path)
panel_save(bw.qc.global_aseg_vol_plot , "bw-qc-global-aseg-vol", "pdf", plot_save_path)
}
```
#####Scatterplot for top betas
```{r, echo = FALSE}
...
bwbyage.qc.global_vol <- as.data.frame(t(sapply(df.zscore[, which(names(df.zscore) %in% vol_vars)], function(x) {
  lm <- lm(x ~ birth_weight_kg*age_years + qc_var + global_eTIV, data = df.zscore)
  summary <- summary(lm)
  c(bw_beta = summary$coefficients[2,1], bw_p = summary$coefficients[2,4], bw_se = summary$coefficients[2,2],
   age_beta = summary$coefficients[3,1], age_p = summary$coefficients[3,4], age_se = summary$coefficients[3,2],
...
if(save_figs == TRUE){
panel_save(bwbyage.qc.global_dkt_vol_plot, "bwbyage-qc-global-dkt-vol", "pdf", plot_save_path)
panel_save(bwbyage.qc.global_aseg_vol_plot , "bwbyage-qc-global-aseg-vol", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(bw.qc.global_dkt_sa_plot, "bw-qc-global-dkt-sa", "pdf", plot_save_path)
}
```
#####Scatterplot for top betas
```{r, echo = FALSE}
...
if(save_figs == TRUE){
panel_save(bwbyage.qc_dkt_sa_plot, "bwbyage-qc-global-dkt-sa", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
bw.qc.global_th <- as.data.frame(t(sapply(df.zscore[, which(names(df.zscore) %in% th_vars)], function(x) {
  lm <- lm(x ~ birth_weight_kg + qc_var + global_MeanThickness, data = df.zscore)
  summary <- summary(lm)
  c(bw_beta = summary$coefficients[2,1], bw_p = summary$coefficients[2,4], bw_se = summary$coefficients[2,2])
})))
...
if(save_figs == TRUE){
panel_save(bw.qc.global_dkt_th_plot, "bw-qc-global-dkt-th", "pdf", plot_save_path)
}
```
#####Scatterplot for top betas
```{r, echo = FALSE}
...
bwbyage.qc.global_th <- as.data.frame(t(sapply(df.zscore[, which(names(df.zscore) %in% th_vars)], function(x) {
  lm <- lm(x ~ birth_weight_kg*age_years + qc_var + global_MeanThickness, data = df.zscore)
  summary <- summary(lm)
  c(bw_beta = summary$coefficients[2,1], bw_p = summary$coefficients[2,4], bw_se = summary$coefficients[2,2],
   age_beta = summary$coefficients[3,1], age_p = summary$coefficients[3,4], age_se = summary$coefficients[3,2],
   bwbyage_beta = summary$coefficients[5,1], bwbyage_p = summary$coefficients[5,4], bwbyage_se = summary$coefficients[5,2])
...
if(save_figs == TRUE){
panel_save(bwbyage.qc.global_dkt_th_plot, "bwbyage-qc-global-dkt-th", "pdf", plot_save_path)
}
```
#####visualize interaction plots
```{r, echo = FALSE}
...
bw.qc.global_th_young <- as.data.frame(t(sapply(df.zscore_young[, which(names(df.zscore_young) %in% th_vars)], function(x) {
  lm <- lm(x ~ birth_weight_kg + qc_var + global_MeanThickness, data = df.zscore_young)
  summary <- summary(lm)
  c(bw_beta = summary$coefficients[2,1], bw_p = summary$coefficients[2,4], bw_se = summary$coefficients[2,2])
})))
...
if(save_figs == TRUE){
panel_save(bw.qc.globalyoung_dkt_th_plot, "bw-qc-meanth-young-dkt-th", "pdf", plot_save_path)
}
```
...
bw.qc.global_th_old <- as.data.frame(t(sapply(df.zscore_old[, which(names(df.zscore_old) %in% th_vars)], function(x) {
  lm <- lm(x ~ birth_weight_kg + qc_var + global_MeanThickness, data = df.zscore_old)
  summary <- summary(lm)
  c(bw_beta = summary$coefficients[2,1], bw_p = summary$coefficients[2,4], bw_se = summary$coefficients[2,2])
})))
...
if(save_figs == TRUE){
panel_save(bw.qc.globalold_dkt_th_plot, "bw-qc-meanth-old-dkt-th", "pdf", plot_save_path)
}
```
#Save scale images
##beta scale
