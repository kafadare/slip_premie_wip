...
#SBATCH --output=/mnt/isilon/bgdlab_processing/Eren/slip_premie_wip/logs/rscript_submit_array_%x_%j.out
#SBATCH --error=/mnt/isilon/bgdlab_processing/Eren/slip_premie_wip/logs/rscript_submit_array_%x_%j.err
